...
const Privacy = () => {
  ...
  if (loading) return <Preloader size={"big"} styleLoader={"clientLoader"} heightWrapLoader={"fullHeight"} />
  ...
  return (
      <div className={"container"}>
        <div className={style.wrapPrivacy}>
          ...
          всей информации, которую Оператор может получить о посетителях веб-сайта {urlSite}.
          </span>
          ...
          обеспечивающих их доступность в сети интернет по сетевому адресу {urlSite}.
              <br />
          ...
          Пользователю веб-сайта {urlSite}.
              <br />
          ...
          распространения).
              <br />
          2.10. Пользователь – любой посетитель веб-сайта {urlSite}.
              <br />
          ...
          системе персональных данных и (или) уничтожаются материальные носители персональных данных.
            ...
            сообщений,
            направив Оператору письмо на адрес электронной почты {"admin@admin.ru"} с пометкой «Отказ от уведомлений о
            новых
            ...
            Пользователем самостоятельно через специальные формы, расположенные на сайте {urlSite} или
            ...
            самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора {"admin@admin.ru"}
              с
            ...
            Оператору
            уведомление посредством электронной почты на электронный адрес Оператора {"admin@admin.ru"} с пометкой «Отзыв
            ...
            персональных данных, обратившись к Оператору с помощью электронной почты {"admin@admin.ru"}.
              <br />
