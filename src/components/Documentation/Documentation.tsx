        ...
        <div className="container">
            <div className={style.documentsWrap}>
                ...
                <div className={style.document}>
                    ...
                    <p className={style.documentText}>Стоимость предельного размера платы за проведение технического осмотра</p>
                    <button className={style.documentationButton}>Посмотреть</button>
                </div>
                <div className={style.document}>
                    <div className={style.backgroundImageDocument}>
                    ...
                    <p className={style.documentText}>Аттестат аккредитации оператора технического осмотра транспортных средств</p>
                    <button className={style.documentationButton}>Посмотреть</button>
                </div>
            </div>
        </div>
